...
import discord, datetime, unicodedata, re, string, pytz, hashlib, requests, random, os, sys, regex, json
...
• a counter to <@!503720029456695306> - twice the bots, double the spam!''', colour = 0x7289da)
	...
	if message.author.discriminator == "0000" and str(message.channel) == "blaze-it":
